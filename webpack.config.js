...
const extensionConfig = {
  ...
  externals: {
    ...
    // sql.js is NOT external - we bundle it but load WASM separately
  },
  plugins: [
    new CopyPlugin({
      patterns: [
        // Use asm.js version - no WASM needed, avoids all WASM loading issues
        { from: 'node_modules/sql.js/dist/sql-asm.js', to: 'sql-asm.js' },
      ],
    }),
  ],
  resolve: {
