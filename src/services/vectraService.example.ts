...
// // Importar tipos de Vectra
// import type { 
//   VectraLocalIndex, 
//   VectraItem, 
//   VectraMetadata, 
//   VectraSearchResult as VectraResult 
// } from '../types/vectra';
...
// // Cargamos el módulo dinámicamente para manejar errores de forma elegante
// async function loadVectraModule(): Promise<typeof VectraLocalIndex | undefined> {
//   try {
...
// // Variables con tipos apropiados
...
//     return results.map((result: VectraResult) => ({
